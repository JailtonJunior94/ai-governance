> **Carregar quando:** producao ou consumo de mensagens, eventos, filas, topicos, outbox pattern, idempotencia de consumidores — **Escopo:** messaging, async, eventos — **~600tk**
